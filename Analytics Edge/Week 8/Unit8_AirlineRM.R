...
#max    (150-Y)*16.12+(150-G)*2.18+(150-M)*2.11+(150-B)*5.23+(150-J)*10.44+(150-C)*5.59+(150-I)*1.13+(150-P)*3.93
#subject to      31.80*Y+24.28*G+32.50*M+14.16*B+50.99*J+24.17*C+23.67*I+28.77*P
